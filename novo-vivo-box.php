            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">Adicionar novo Vivo Box</h1>

                        <div class="form-group">
                            <?php
                            if (isset($_GET['msgvivobox'])) {
                                echo $_GET['msgvivobox'];
                                unset($_GET['msgvivobox']);
                            }
                            ?>
                        </div>
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">                               
                                ...
                                <form method="POST" action="include/novo_vivo_box.php">
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select name="tipoequipamento" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>Roteador 3G/4G - Vivo Box</option>
                                                <option>Roteador 3G/4G - Outros</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Modelo</label>
                                            <select name="modelo" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>MAXIS B660</option>
                                                <option>DWR</option>
                                                <option>WLD71-T5</option>
