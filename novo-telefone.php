            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">Adicionar novo telefone</h1>
                        <div class="form-group animated--grow-in" >
                            <?php
                            if (isset($_GET['msgtelefone'])) {
                                echo $_GET['msgtelefone'];
                                unset($_GET['msgtelefone']);
                            }
                            ?>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">                               
                                ...
                                <form method="POST" action="include/novo_telefone.php">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>Cód. do Setor</label>
                                            <input type="text" class="form-control" name="codsetor">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Setor</label>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            <label>IMEI Aparelho</label>
                                            <input type="text" class="form-control" name="imeiaparelho">
                                        </div>
                                        <div class="form-group col-md-2">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select name="modelo" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>Moto G</option>
                                                <option>Moto C</option>
                                                <option>Moto E</option>
                                                <option>Pixi 3</option>
                                                <option>iPhone</option>
                                                <option>Vivo Box</option>
                                                <option>Outros</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Nº de Série</label>
                                            <input type="text" class="form-control" name="ndeserie">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Tipo de Defeito</label>
                                            <select name="tipodefeito" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>Tela quebrada</option>
                                                <option>Bateria ruim</option>
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>Situação do Aparelho</label>
                                            <select name="situacaoaparelho" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>Em uso</option>
                                                <option>Defeito</option>
                                                <option>Disponível</option>
                                                <option>Furtado</option>
                                            </select>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" name="ndalinha">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>IMEI CHIP</label>
                                            <input type="text" class="form-control" name="imeichip">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Qtd. Dados</label>
                                            <select name="qtddados" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>1GB</option>
                                                <option>2GB</option>
                                                <option>3GB</option>
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>Qtd. Minutos</label>
                                            <select name="qtdminutos" class="form-control">
                                                <option selected>Selecione</option>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select name="compartilhado" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>Sim</option>
                                                <option>Não</option>
                                            </select>
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>Situação da Linha</label>
                                            <select name="situacaodalinha" class="form-control">
                                                <option selected>Selecione</option>
                                                <option>Ativa</option>
                                                <option>Cancelada</option>
                                                <option>Bloqueada</option>
                                                <option>Disponível</option>
                                                <option>Furtada</option>
                                            </select>
                                        </div>   
