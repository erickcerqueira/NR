...
<html lang="pt-br">
    ...
    <body>
        ...
        $arquivo = 'relatoriodevivoboxs.xls';

        // Criamos uma tabela HTML com o formato da planilha
        $html = '';
        $html .= '<table border="1">';
        $html .= '<tr>';
        $html .= '<td colspan="24">Relatorio de Telefones</tr>';
        $html .= '</tr>';
        ...
        $html .= '<td><b>Tipo de Equipamento</b></td>';
        ...
        $result_excel = "SELECT * FROM vivoboxs";
        ...
        while ($row_excel = mysqli_fetch_assoc($resultado_excel)) {
            ...
            $html .= '<td>' . $row_excel["tipoequipamento"] . '</td>';
